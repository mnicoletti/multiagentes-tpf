...
_ALLOWED_MSGPACK_MODULES: list[tuple[str, ...]] = [
    ...
    ("portfoliosentinel.graph.state", "PlanAction"),
    ("portfoliosentinel.graph.state", "MlSignalCitation"),
    ("portfoliosentinel.graph.state", "RebalancePlan"),
    ("portfoliosentinel.graph.state", "ValidationViolation"),
    ("portfoliosentinel.graph.state", "ValidationResult"),
    ("portfoliosentinel.graph.state", "ReportLintResult"),
